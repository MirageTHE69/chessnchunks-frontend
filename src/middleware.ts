...
export default withAuth(
  function middleware(req) {
    ...
    if (role === "STUDENT" as "student" && pathname === "/assign-puzzle-coach") {

      return Response.redirect(new URL("/", req.url));
    }
    if (role === "STUDENT" as "student" && pathname === "/assign-quiz-coach") {
    ...
    if (role === "STUDENT" as "student" && pathname === "/coach-communication") {
    ...
    if (role === "COACH" as "coach" && pathname === "/student-communication") {
...
export const config = { matcher: ["/student-dashboard", "/coach-dashboard","/student-communication","/coach-communication","/assign-puzzle-coach","/play-with-batch","/assign-quiz-coach"] };
