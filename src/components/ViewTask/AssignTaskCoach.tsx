...
const AssignTaskCoach = () => {
    return (
        <div className="min-h-screen p-8 bg-gray-900 text-white flex flex-col items-left">
            ...
            <div className="mb-4 w-full max-w-md">
                <label htmlFor="assignHomework" className="block mb-1">Assign Homework:</label>
                <select id="assignHomework" className="w-full p-2 bg-gray-800 border border-gray-700 rounded">
...
export default AssignTaskCoach;
