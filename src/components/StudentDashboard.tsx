      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-1">
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col items-center">
            ...
            <div className="grid grid-cols-2 gap-8 mb-10">
              {[
                { label: "AI", rating: 1607, bgColor: "bg-[#D43235]" }, // Updated color
                { label: "Academy", rating: 4524, bgColor: "bg-[#01A3A1]" }, // Updated color
                { label: "Batch", rating: 4561, bgColor: "bg-[#F9A500]" }, // Updated color
                { label: "Friends", rating: 5234, bgColor: "bg-[#D43235]" }, // Updated color
              ].map((rating, index) => (
                <div
                  key={index}
            ...
            <div
              className="flex flex-col items-center justify-center bg-[#F9A500] p-4 text-white rounded-full"
        ...
        <div className="col-span-2 bg-gray-900 p-6 rounded-lg flex flex-col items-center relative">
          ...
          <div className="flex flex-col space-y-4 w-full items-center">
            {["AI", "Academy", "Batch", "Friends", "Online"].map(
              (match, index) => (
                <button
                  key={index}
                  className="bg-[#01A3A1] py-4 w-48 rounded-full text-white text-lg transition duration-300 hover:bg-[#D43235]" // Updated colors
                >
                  {match}
                </button>
              )
          ...
          <div className="mt-6">
            <button
              className="bg-[#D43235] py-4 px-6 rounded-lg flex items-center space-x-2 text-white text-lg focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-[#01A3A1] transition-colors" // Updated colors
              onClick={() => {
