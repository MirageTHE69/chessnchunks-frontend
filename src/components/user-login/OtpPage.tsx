...
function OtpVerification() {
  ...
  const handleSubmit = () => {
    ...
    // Add your OTP verification logic here (e.g., send OTP to your API for validation)
    console.log("Verifying OTP:", otpValue);
    router.push('/student-dashboard'); // Redirect after successful verification
  };
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-900">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-96">
        ...
        <p className="text-gray-400 text-center mb-4">Enter the code sent to your E-mail ID</p>
        ...
        <div className="text-center mb-6">
          <p className="text-gray-400">Resend OTP in: <span className="font-semibold text-white">00:{timer < 10 ? `0${timer}` : timer}</span></p>
          <button 
            className="text-blue-500 mt-2 hover:underline" 
            disabled={timer !== 0} 
            onClick={() => { setTimer(30); resetOtp(); }}
          >
            Resend
          </button>
        </div>
